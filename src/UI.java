...
import filemanager.CreateNewFolderJDialog;
import filemanager.RenameJDialog;
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(!dirsCache.isEmpty()){
                    String currentPath;
                    File newFolder;
                    filemanager.CreateNewFolderJDialog newFolderJDialog = new CreateNewFolderJDialog(UI.this);
        ...
        renameButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(!dirsCache.isEmpty() & filesList.getSelectedValue() != null){
                    ...
                    String currentPath = toFullPath(dirsCache);
                    String selectedObject = filesList.getSelectedValue().toString();
                    filemanager.RenameJDialog renamer = new RenameJDialog(UI.this);
                    if(renamer.getReady()){
